...
/*
 * ACPI feature toggles to enable EC lid and wake.
 *
 * Unlike the other Framework platforms (which use the eSPI virtual wire,
 * GPE0_ESPI), sunflower routes the EC's SCI and wake notification over a
 * dedicated EC_SCI# line on GPP_D19. With "pmc_gpe0_dw1 = GPP_D" in the
 * devicetree, that pad maps to GPE0_DW1_19.
 */

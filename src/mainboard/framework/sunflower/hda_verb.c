...
static const u32 realtek_alc285_verbs[] = {
	...
	/* Subsystem ID: 0xf111000c */

	AZALIA_SUBVENDOR(0, 0xf111000c),
	AZALIA_RESET(1),

	/* Pin widget configurations */
	AZALIA_PIN_CFG(0, 0x12, 0x90a60130), /* DMIC - Internal Mic */
	AZALIA_PIN_CFG(0, 0x13, 0x40000000), /* DMIC - NC */
	AZALIA_PIN_CFG(0, 0x14, 0x90170110), /* Front (Port-D) - Internal Speaker */
	...
	AZALIA_PIN_CFG(0, 0x21, 0x04211020), /* HP1-OUT (Port-I) - Headphone Jack */
